...
export interface ExceptionsFilterConfig {
    ...
    transformMessage?: (message: string | string[], exception: unknown, request: Request) => string | string[];
    logger?: FilterLogger;
}
export declare const EXCEPTIONS_FILTER_CONFIG: unique symbol;
//# sourceMappingURL=filter-config.interface.d.ts.map